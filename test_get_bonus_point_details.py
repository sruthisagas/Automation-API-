...
class Test:
    ...
    def test_get_bonus_point_details(self, auth_token_data):
        api_url = "https://some-URL/api/points"
        ...
        for i in access_token:
            ...
            if r.status_code == 201:
                print("Passed: Bonus Point details found successfully.")
            else:
                print("Failed: Bonus Point details not found successfully.")
        x = "carddev@sep27.com"
        y = "123456"
