...
class Test:
    ...
    def test_get_user_shortcut_links(self, auth_token_data):
        api_url = "https://some-URL/api/system/shortcut/links"
        ...
        for i in access_token:
            ...
            print(status)
            if status == 201:
                print("Passed:  shortcut links displayed successfully.")
            else:
                print("Failed:  shortcut links not displayed successfully", message)
