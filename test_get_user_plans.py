...
class Test:
    ...
    def test_get_user_plans(self, auth_token_data):
        api_url = "https://some-URL/api/user/plans"
        ...
        print(json.dumps(parsed_json, indent=4, sort_keys=True))
        if r.status_code == 201:
            print("Passed: User plans displayed successfully.")
        else:
            print("Failed: User plans not found.")
